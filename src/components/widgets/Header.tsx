...
export default component$(() => {
  ...
  return (
    <header
      id="header"
      class={`sticky top-0 z-40 flex-none mx-auto bg-gradient-to-r from-white to-gray-50 dark:from-gray-950 dark:to-gray-900    w-full border-b border-gray-300 dark:border-gray-700 transition-[opacity] ease-in-out ${store.isScrolling
          ? "    "
          : ""
        }`}
      window:onScroll$={() => {
    ...
    >
      ...
      <div class="w-full hidden h-7 px-2 md:px-7 border-b border-gray-300 dark:border-gray-700 mx-auto bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-900 dark:to-gray-800 flex justify-between items-center max-w-7xl relative">
        <div>
          <p>Safe & Auto Inc.</p>
        </div>
      ...
      <div class="relative text-default py-2 px-2 md:px-6 mx-auto w-full md:flex md:justify-between max-w-7xl">
        <div class="mr-auto rtl:mr-0 rtl:ml-auto flex justify-between">
          ...
          <div class="flex items-center md:hidden">
            <a
              href="/contact"
              class="btn bg-gray-200 border-gray-300 dark:bg-gray-800 dark:border-gray-700 rounded-sm ml-2 mr-1.5 h-12 py-2.5 px-4 md:px-4 font-semibold shadow-none text-md w-auto"
            >
              Contact Us
            </a>
