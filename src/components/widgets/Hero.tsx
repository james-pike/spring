...
>
  Get A Quote
        ...
        {/* LogoClouds */}
        <div class="bg-gradient-to-r from-gray-200 to-gray-50 md:animate-scroll dark:from-gray-900 dark:to-gray-700 col-span-1 md:col-span-2 flex items-center justify-center py-4 order-3">
          <LogoClouds />
        </div>
      </div>
    </section>
