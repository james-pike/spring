...
export default component$(() => {
  return (
    <section class="relative overflow-hidden">
      <div class="grid bg-gradient-to-r from-primary/40 via-muted to-primary/20 dark:from-background dark:to-muted grid-cols-1 md:grid-cols-2 grid-rows-[auto_auto] md:grid-rows-[85%_15%] min-h-[calc(100vh-89px)]">
        {/* Text Content */}
