...
export const panelVariants = cva(
  [
    'fixed w-full  dark:bg-gray-800 p-5 text-foreground border-2 border-gray-200 dark:border-gray-700 transition-all backdrop:brightness-50 backdrop:backdrop-blur-sm',
