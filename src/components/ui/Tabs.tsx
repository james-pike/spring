  ...
  return (
    <HeadlessTabs.Tab
      ...
      class={cn(
       ...
       'data-[state=selected]:bg-gray-900 data-[state=selected]:border-b data-[state=selected]:border-b-primary',
...
const Panel = component$<PropsOf<typeof HeadlessTabs.Panel>>((props) => {
  return (
    <HeadlessTabs.Panel
      {...props}
      class={cn(
        'mt-1.5 ring-offset-background bg-gray-850 rounded-b-base border border-gray-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2',
        props.class
      )}
    >
      <Slot />
